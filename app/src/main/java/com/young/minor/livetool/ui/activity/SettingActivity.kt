...
import com.young.minor.livetool.base.BaseActivity
...
class SettingActivity : BaseActivity() {
    ...
    private fun setConfig() {
        ...
        when (preview_res_group.checkedRadioButtonId) {
            R.id.preview_480 -> {
                baseConfig!!.mPreviewResolution = StreamerConstants.VIDEO_RESOLUTION_360P
            }
            R.id.preview_720 -> {
                baseConfig!!.mPreviewResolution = StreamerConstants.VIDEO_RESOLUTION_540P
            }
            R.id.preview_1080 -> {
                baseConfig!!.mPreviewResolution = StreamerConstants.VIDEO_RESOLUTION_720P
            }
        }
